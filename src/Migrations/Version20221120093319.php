 ...
 */
final class Version20221120093319 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE `order` ADD spk_file LONGTEXT DEFAULT NULL, ADD bapd_file LONGTEXT DEFAULT NULL, CHANGE work_unit work_unit JSON DEFAULT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE `order` DROP spk_file, DROP bapd_file, CHANGE work_unit work_unit LONGTEXT CHARACTER SET utf8mb4 DEFAULT NULL COLLATE `utf8mb4_bin`');
