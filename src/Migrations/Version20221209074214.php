 ...
 */
final class Version20221209074214 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE `order` ADD treasurer_pph VARCHAR(255) DEFAULT NULL, DROP received_at, DROP spk_file, DROP bapd_file, CHANGE work_unit work_unit JSON DEFAULT NULL, CHANGE tax_type tax_type VARCHAR(255) DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE `order` ADD received_at DATETIME DEFAULT NULL, ADD spk_file LONGTEXT CHARACTER SET utf8mb4 DEFAULT NULL COLLATE `utf8mb4_0900_ai_ci`, ADD bapd_file LONGTEXT CHARACTER SET utf8mb4 DEFAULT NULL COLLATE `utf8mb4_0900_ai_ci`, DROP treasurer_pph, CHANGE work_unit work_unit LONGTEXT CHARACTER SET utf8mb4 DEFAULT NULL COLLATE `utf8mb4_bin`, CHANGE tax_type tax_type INT DEFAULT NULL');
