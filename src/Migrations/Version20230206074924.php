 ...
 */
final class Version20230206074924 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user_pic_document ADD satker LONGTEXT DEFAULT NULL, ADD klpd LONGTEXT DEFAULT NULL, CHANGE user_id user_id BIGINT DEFAULT NULL, CHANGE created_at created_at DATETIME NOT NULL');
        $this->addSql('ALTER TABLE user_ppk_treasurer ADD satker LONGTEXT DEFAULT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user_pic_document DROP satker, DROP klpd, CHANGE user_id user_id BIGINT NOT NULL, CHANGE created_at created_at DATETIME DEFAULT NULL');
        $this->addSql('ALTER TABLE user_ppk_treasurer DROP satker');
    }
}
