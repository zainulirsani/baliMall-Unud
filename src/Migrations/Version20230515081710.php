 ...
 */
final class Version20230515081710 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE satker ADD user_id BIGINT DEFAULT NULL');
        $this->addSql('ALTER TABLE satker ADD CONSTRAINT FK_9E781CC9A76ED395 FOREIGN KEY (user_id) REFERENCES user (id)');
        $this->addSql('CREATE INDEX IDX_9E781CC9A76ED395 ON satker (user_id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE satker DROP FOREIGN KEY FK_9E781CC9A76ED395');
        $this->addSql('DROP INDEX IDX_9E781CC9A76ED395 ON satker');
        $this->addSql('ALTER TABLE satker DROP user_id');
