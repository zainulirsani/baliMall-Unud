 ...
 */
final class Version20220808195338 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE `order` ADD unit_address LONGTEXT DEFAULT NULL, CHANGE work_unit work_unit JSON DEFAULT NULL, CHANGE djp_report_status unit_telp VARCHAR(255) DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE user_pic_document CHANGE created_at created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', CHANGE updated_at updated_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\'');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE `order` DROP unit_address, CHANGE work_unit work_unit LONGTEXT CHARACTER SET utf8mb4 DEFAULT NULL COLLATE `utf8mb4_bin`, CHANGE unit_telp djp_report_status VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT NULL COLLATE `utf8mb4_0900_ai_ci`');
        ...
        $this->addSql('ALTER TABLE user_pic_document CHANGE created_at created_at DATETIME DEFAULT NULL, CHANGE updated_at updated_at DATETIME DEFAULT NULL');
    }
}
