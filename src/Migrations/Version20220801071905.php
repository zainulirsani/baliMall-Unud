 ...
 */
final class Version20220801071905 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE `order` ADD unit_pic VARCHAR(255) DEFAULT NULL, ADD unit_email VARCHAR(255) DEFAULT NULL, CHANGE work_unit work_unit JSON DEFAULT NULL, CHANGE djp_report_status unit_name VARCHAR(255) DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE `order` ADD djp_report_status VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT NULL COLLATE `utf8mb4_0900_ai_ci`, DROP unit_name, DROP unit_pic, DROP unit_email, CHANGE work_unit work_unit LONGTEXT CHARACTER SET utf8mb4 DEFAULT NULL COLLATE `utf8mb4_bin`');
