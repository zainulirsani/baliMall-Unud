 ...
 */
final class Version20220810063836 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE order_shipped_file (id INT AUTO_INCREMENT NOT NULL, order_id BIGINT NOT NULL, filename VARCHAR(255) NOT NULL, filepath LONGTEXT NOT NULL, created_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', INDEX IDX_EAA4949BFCDAEAAA (order_id_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('ALTER TABLE order_shipped_file ADD CONSTRAINT FK_EAA4949BFCDAEAAA FOREIGN KEY (order_id) REFERENCES `order` (id)');
        ...
        $this->addSql('ALTER TABLE `order` DROP djp_report_status, CHANGE work_unit work_unit JSON DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE user_pic_document CHANGE user_id user_id BIGINT DEFAULT NULL, CHANGE created_at created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', CHANGE updated_at updated_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\'');
        $this->addSql('ALTER TABLE user_pic_document ADD CONSTRAINT FK_DEBAF7EFA76ED395 FOREIGN KEY (user_id) REFERENCES user (id) ON DELETE SET NULL');
        $this->addSql('CREATE INDEX IDX_DEBAF7EFA76ED395 ON user_pic_document (user_id)');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP TABLE order_shipped_file');
        ...
        $this->addSql('ALTER TABLE `order` ADD djp_report_status VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT NULL COLLATE `utf8mb4_0900_ai_ci`, CHANGE work_unit work_unit LONGTEXT CHARACTER SET utf8mb4 DEFAULT NULL COLLATE `utf8mb4_bin`');
