 ...
 */
final class Version20230425194457 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user ADD digit_satker VARCHAR(255) DEFAULT NULL, CHANGE first_name first_name VARCHAR(100) DEFAULT NULL, CHANGE nik nik VARCHAR(255) DEFAULT NULL, CHANGE lkpp_role lkpp_role VARCHAR(255) NOT NULL, CHANGE sub_role sub_role VARCHAR(255) DEFAULT NULL, CHANGE sub_role_type_account sub_role_type_account VARCHAR(255) DEFAULT NULL');
    }
