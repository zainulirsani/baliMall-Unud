 ...
 */
final class Version20220818025221 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE `order` CHANGE work_unit work_unit JSON DEFAULT NULL, CHANGE djp_report_status self_courier_telp VARCHAR(255) DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE order_shipped_file CHANGE created_at created_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\'');
        $this->addSql('ALTER TABLE order_shipped_file ADD CONSTRAINT FK_EAA4949B8D9F6D38 FOREIGN KEY (order_id) REFERENCES `order` (id)');
        $this->addSql('ALTER TABLE order_shipped_file RENAME INDEX idx_eaa4949bfcdaeaaa TO IDX_EAA4949B8D9F6D38');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE `order` CHANGE work_unit work_unit LONGTEXT CHARACTER SET utf8mb4 DEFAULT NULL COLLATE `utf8mb4_bin`, CHANGE self_courier_telp djp_report_status VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT NULL COLLATE `utf8mb4_0900_ai_ci`');
