 ...
 */
final class Version20230206154052 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user CHANGE first_name first_name VARCHAR(100) DEFAULT NULL, CHANGE ip_address ip_address VARCHAR(40) DEFAULT NULL, CHANGE surat_ijin_file surat_ijin_file LONGTEXT DEFAULT NULL, CHANGE dokumen_file dokumen_file LONGTEXT DEFAULT NULL, CHANGE lkpp_role lkpp_role VARCHAR(255) NOT NULL, CHANGE is_user_testing send_email_access TINYINT(1) DEFAULT NULL');
    }
