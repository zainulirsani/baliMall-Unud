 ...
 */
final class Version20230425035513 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE bni ADD user_id BIGINT DEFAULT NULL');
        $this->addSql('ALTER TABLE bni ADD CONSTRAINT FK_7B025989A76ED395 FOREIGN KEY (user_id) REFERENCES user (id)');
        $this->addSql('CREATE INDEX IDX_7B025989A76ED395 ON bni (user_id)');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE bni DROP FOREIGN KEY FK_7B025989A76ED395');
        $this->addSql('DROP INDEX IDX_7B025989A76ED395 ON bni');
        $this->addSql('ALTER TABLE bni DROP user_id');
