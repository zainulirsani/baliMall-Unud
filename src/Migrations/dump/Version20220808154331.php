 ...
 */
final class Version20220808154331 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user_pic_document ADD user_id_id BIGINT NOT NULL, ADD user_id BIGINT NOT NULL');
        $this->addSql('ALTER TABLE user_pic_document ADD CONSTRAINT FK_DEBAF7EF9D86650F FOREIGN KEY (user_id_id) REFERENCES user (id)');
        $this->addSql('ALTER TABLE user_pic_document ADD CONSTRAINT FK_DEBAF7EFA76ED395 FOREIGN KEY (user_id) REFERENCES user (id)');
        $this->addSql('CREATE INDEX IDX_DEBAF7EF9D86650F ON user_pic_document (user_id_id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user_pic_document DROP FOREIGN KEY FK_DEBAF7EF9D86650F');
        $this->addSql('ALTER TABLE user_pic_document DROP FOREIGN KEY FK_DEBAF7EFA76ED395');
        $this->addSql('DROP INDEX IDX_DEBAF7EF9D86650F ON user_pic_document');
        $this->addSql('DROP INDEX IDX_DEBAF7EFA76ED395 ON user_pic_document');
        $this->addSql('ALTER TABLE user_pic_document DROP user_id_id, DROP user_id');
    }
}
