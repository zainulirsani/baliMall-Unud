 ...
 */
final class Version20230206081616 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user ADD secure_random_code VARCHAR(20) DEFAULT NULL, DROP is_user_testing, CHANGE first_name first_name VARCHAR(100) DEFAULT NULL, CHANGE ip_address ip_address VARCHAR(40) DEFAULT NULL, CHANGE surat_ijin_file surat_ijin_file LONGTEXT DEFAULT NULL, CHANGE dokumen_file dokumen_file LONGTEXT DEFAULT NULL, CHANGE lkpp_role lkpp_role VARCHAR(255) NOT NULL');
    }
