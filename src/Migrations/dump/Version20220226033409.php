 ...
 */
final class Version20220226033409 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE `order` ADD ppk_type VARCHAR(255) DEFAULT NULL, ADD treasurer_type VARCHAR(255) DEFAULT NULL');
    }
