 ...
 */
final class Version20230509165130 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE satker (id INT AUTO_INCREMENT NOT NULL, satker_name VARCHAR(255) NOT NULL, digit_va VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
    }
