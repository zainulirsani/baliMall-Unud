 ...
 */
final class Version20220225082822 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE `order` ADD work_unit_name VARCHAR(255) DEFAULT NULL, ADD institution_name VARCHAR(255) DEFAULT NULL, ADD budget_account VARCHAR(255) DEFAULT NULL, ADD ppk_name VARCHAR(255) DEFAULT NULL, ADD ppk_nip VARCHAR(255) DEFAULT NULL, ADD treasurer_name VARCHAR(255) DEFAULT NULL, ADD treasurer_nip VARCHAR(255) DEFAULT NULL');
