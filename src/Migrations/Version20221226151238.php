 ...
 */
final class Version20221226151238 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE `order` ADD other_document LONGTEXT DEFAULT NULL, DROP received_at, DROP spk_file, DROP bapd_file, CHANGE work_unit work_unit JSON DEFAULT NULL, CHANGE tax_type tax_type VARCHAR(255) DEFAULT NULL, CHANGE treasurer_pph treasurer_pph VARCHAR(255) DEFAULT NULL, CHANGE treasurer_pph_nominal treasurer_pph_nominal VARCHAR(100) DEFAULT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE `order` ADD received_at DATETIME DEFAULT NULL, ADD bapd_file LONGTEXT CHARACTER SET utf8mb4 DEFAULT NULL COLLATE `utf8mb4_0900_ai_ci`, CHANGE work_unit work_unit LONGTEXT CHARACTER SET utf8mb4 DEFAULT NULL COLLATE `utf8mb4_bin`, CHANGE tax_type tax_type INT DEFAULT NULL, CHANGE treasurer_pph treasurer_pph VARCHAR(100) CHARACTER SET utf8mb4 DEFAULT NULL COLLATE `utf8mb4_0900_ai_ci`, CHANGE treasurer_pph_nominal treasurer_pph_nominal VARCHAR(50) CHARACTER SET utf8mb4 DEFAULT NULL COLLATE `utf8mb4_0900_ai_ci`, CHANGE other_document spk_file LONGTEXT CHARACTER SET utf8mb4 DEFAULT NULL COLLATE `utf8mb4_0900_ai_ci`');
